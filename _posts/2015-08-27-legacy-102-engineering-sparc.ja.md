---
layout: post
title: "[SPARC] 浮動小数点数の引数渡し"
description: "添付ファイルに基づいた…私の成果物です。涙。時間の都合上、そのまま入れています…まだ最適化していません涙。nopの饗宴…と繰り返されるラベルたち涙。"
...
<div class="column">
<p>
添付ファイルに基づいた…私の成果物です。涙。
</p>
<p>
時間の都合上、そのまま入れています…まだ最適化していません涙。nopの饗宴…と繰り返されるラベルたち涙。
</p>
