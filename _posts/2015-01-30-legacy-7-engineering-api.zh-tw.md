---
layout: post
title: "Chrome 擴充功能 API 清單整理"
description: "這是一份 Chrome 擴充功能 API 清單整理。清單是利用 Python 提取的。點擊相關標題即可下載對應的範例原始碼。將原始碼解壓縮後放入 Chrome 擴充功能中，範例即可運作。My Bookmarks Page Redder Print this pag..."
...
<p>
將原始碼解壓縮後放入 Chrome 擴充功能中，範例即可運作。
</p>
